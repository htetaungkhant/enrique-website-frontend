                ...
                <div className="w-full flex gap-12 max-lg:flex-col xl:gap-16">
                    <div className="flex-1 flex flex-col gap-6">
                        <div className="flex justify-between">
                            <h2 className="text-lg xltext-xl font-bold text-[#8A8A8A]">Contact Details</h2>
                            <TbEdit className="w-5 h-5 xlw-7 xlh-7 text-[#96CD78] cursor-pointer" />
                        </div>
                    ...
                    <div className="flex-1 flex flex-col gap-6">
                        <div className="flex justify-between">
                            <h2 className="text-lg xltext-xl font-bold text-[#8A8A8A]">Participant Details</h2>
                            <TbEdit className="w-5 h-5 xlw-7 xlh-7 text-[#96CD78] cursor-pointer" />
                        </div>
                        <div className="bg-white rounded-2xl text-[#494A4A]">
                            <div className="p-4 flex justify-between">
