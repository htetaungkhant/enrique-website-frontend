...
const CeremonyParticipants = ({ participants = [], total, currentPage, sortByDate }) => {
    ...
    return (
        <AdminPagesWrapper>
            <div className="p-6 flex flex-col gap-4">
                <h1 className="text-2xl text-white font-bold">Participant Management</h1>
                        ...
                        <TableBody>
                            {filteredParticipants.map((participant) => (
                                <TableRow key={participant.id}>
                                    ...
                                    <TableCell>{participant.mobile ? formatPhoneNumber(participant.mobile) : "N/A"}</TableCell>
                                    <TableCell>
                                        ...
                                        <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        <strong className="text-red-600">This action cannot be undone.</strong> This will permanently delete the participant.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
                                                    <AlertDialogCancel
