	...
	return (
		<main>
			...
			<InfoSection image="/image/SacredGuidance.png" reverse={true}>
				...
				<p className="text-white inter-font">Discover the profound wisdom and preparation steps for your sacred medicine journey with the <Link href="" target="_blank" className="text-[#fef15c]">Sacred Ceremonial Guide</Link>. This comprehensive guide provides essential insights on emotional, mental, physical, and spiritual preparation, integration practices, and the healing power of 5 MeO. Whether you are new to the experience or looking to deepen your understanding, this guide will help you navigate the path with clarity and intention.</p>
			...
			<InfoSection image="/image/BufoCeremony.png" smallImage={true}>
				...
				<p className="text-white inter-font">A Toad Medicine ceremony, often called a toad ceremony, involves the use of venom from the Sonoran Desert Toad (Toad Medicine), which contains 5 MeO. The ceremony follows a structured process to enhance the experience while ensuring safety and support.</p>
				<p className="text-white inter-font">Known as El Sapo in Spanish, Bufo secretes a milky white substance rich in <Link href="https://www.forbes.com/sites/davidcarpenter/2020/02/02/5-meo-dmt-the-20-minute-psychoactive-toad-experience-thats-transforming-lives/" target="_blank" className="text-[#fef15c]">5 MeO</Link>. Its effects are fast-acting, and unlike many other powerful psychedelics, it typically does not cause nausea or vomiting. To support ecological conservation, our ceremonies also offer a synthetic 5 MeO alternative, reducing the impact on the Sonoran Desert Toad and its habitat.</p>
			</InfoSection>
			<InfoSection image="/image/SmokingBufo.png" smallImage={true} reverse={true}>
				...
				<p className="text-white inter-font">The venom of the Toad Medicine toad is carefully extracted through a process known as "milking," then dried for use. When smoked through a pipe, the heat neutralizes toxic components, allowing the user to inhale only the active 5 MeO vapor.</p>
			...
			<InfoSection image="/image/Bufo.png" reverse={true}>
				...
				<p className="text-white inter-font">
					<span className="font-bold">Dissolution of the Ego–</span> <Link href="https://www.forbes.com/sites/davidcarpenter/2020/02/02/5-meo-dmt-the-20-minute-psychoactive-toad-experience-thats-transforming-lives/" target="_blank" className="text-[#fef15c]">The effects of 5 MeO</Link> facilitate the breakdown of personal boundaries, allowing for deep introspection and transformation.
				</p>
				<p className="text-white inter-font">
