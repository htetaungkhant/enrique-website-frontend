    ...
    const onClickFacilitatorsCard = (facilitator) => {
        ...
        setSelectedFacilitators({
            ...
            cardList: facilitator.areaOfExpertise?.map((item) => ({
                badgeText: "Expertise",
                title: typeof item.title && item.title.includes("__html") ? JSON.parse(item.title) : item.title,
                        ...
                        <div className="flex flex-col inter-font">
                            ...
                            <div className="flex flex-col gap-10">
                                <div className="flex flex-col gap-5">
                                    ...
                                    {
                                        typeof selectedFacilitators.about === 'object' && Object.keys(selectedFacilitators.about).length === 1 && Object.keys(selectedFacilitators.about).includes('__html') ?
                                            <p className="text-xs md:text-sm font-medium" dangerouslySetInnerHTML={selectedFacilitators.about}></p>
                                            :
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <SwiperCardsRowSection
                                        breakpoints={{
                                            768: {
                                                slidesPerView: selectedFacilitators?.cardList?.length || 3,
                                            },
                                        }}
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <ul className="flex flex-col gap-2 md:gap-3">
                                        {
                                            Array.isArray(selectedFacilitators.workImpact) && selectedFacilitators.workImpact.length > 0 &&
                                            (selectedFacilitators.workImpact.map((item, index) => (
                                                <li key={`workImpact-${index}`} className="flex gap-3 md:gap-5">
                                                    <HiBadgeCheck size={26} color="#2EAC25" className="min-w-6" />
                                                    <div>
                                                        {item.title && <span className="font-bold mr-1">{item.title}</span>}
