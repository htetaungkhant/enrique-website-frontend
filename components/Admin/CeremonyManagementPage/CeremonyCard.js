            ...
            {startDate && endDate && (
              <>
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <div>
                    {format(toZonedTime(new Date(startDate), "UTC"), "h:mm a", {
                      timeZone: "UTC",
                    })}{" "}
                    -{" "}
                    {format(toZonedTime(new Date(endDate), "UTC"), "h:mm a", {
                      timeZone: "UTC",
                    })}
                  </div>
                </div>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    This will permanently delete the ceremony and all associated
                    data.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
