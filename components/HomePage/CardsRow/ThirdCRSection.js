            ...
            <div className="flex flex-wrap justify-between gap-4 lg:gap-8">
                <Card className="flex-1" badgeText="Integration">
                    <div className="flex flex-col gap-4 inter-font text-[#022645]">
                        <h2 className="font-normal text-xl md:text-2xl lg:text-4xl"><strong className="font-bold">Grounding</strong> <br />Practices</h2>
                ...
                <Card className="flex-1" badgeText="Integration">
                    <div className="flex flex-col gap-4 inter-font text-[#022645]">
                        <h2 className="font-normal text-xl md:text-2xl lg:text-4xl"><strong className="font-bold">Time for</strong> <br />Reflection</h2>
                ...
                <Card className="flex-1" badgeText="Integration">
                    <div className="flex flex-col gap-4 inter-font text-[#022645]">
                        <h2 className="font-normal text-xl md:text-2xl lg:text-4xl"><strong className="font-bold">Creative</strong> <br />Expression</h2>
                ...
                <Card className="flex-1" badgeText="Integration">
                    <div className="flex flex-col gap-4 inter-font text-[#022645]">
                        <h2 className="font-normal text-xl md:text-2xl lg:text-4xl"><strong className="font-bold">Daily</strong> <br />Self-Care</h2>
                ...
                <Card className="flex-1" badgeText="Integration">
                    <div className="flex flex-col gap-4 inter-font text-[#022645]">
                        <h2 className="font-normal text-xl md:text-2xl lg:text-4xl"><strong className="font-bold">Community</strong> <br />& Support</h2>
