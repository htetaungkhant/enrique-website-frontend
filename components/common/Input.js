    ...
    return (
      <div className={cn("flex flex-col gap-1", className)}>
        ...
        <div className="relative flex items-center">
          {!phone && customPlaceholder && (
            <span
              className={cn(
                "line-clamp-1 absolute left-[5.5rem] text-gray-400 text-xs md:text-sm z-10",
                customPlaceholderClassName
              )}
      ...
      <div className={cn("min-w-16 flex flex-col gap-1 p-[1px]", className)}>
        ...
        <div className="flex flex-col">
          <div className="flex items-center relative">
            ...
            {isPassword ? (
              <HiMiniEyeSlash
                className="text-lg absolute right-3 rotate-x-180 cursor-pointer text-[#848484] hover:text-gray-600"
